...
(function () {
  ...
  function initMobileBottomNav() {
    ...
    nav.innerHTML = [
      ...
      '</a>',
      '<a href="europe-orders.html" class="mbn-item" data-page="europe-orders.html">',
      '  <i class="fas fa-road"></i><span>Европа</span>',
      '</a>',
      '<a href="premium.html" class="mbn-item mbn-item--premium" data-page="premium.html">',
